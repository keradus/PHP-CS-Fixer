...
final class ProjectCodeTest extends TestCase
{
    ...
    public function testThatSrcClassHaveTestClass($className)
    {
        ...
        $this->assertTrue(
            is_subclass_of($testClassName, \PhpCsFixer\TestingBase\AbstractTestCase::class),
            sprintf('Expected test class "%s" to be a subclass of %s.', $testClassName, \PhpCsFixer\TestingBase\AbstractTestCase::class)
        );
    }
