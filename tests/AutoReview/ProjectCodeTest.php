...
final class ProjectCodeTest extends TestCase
{
    ...
    public function testThatSrcClassHaveTestClass($className)
    {
        ...
        $this->assertTrue(is_subclass_of($testClassName, '\PhpCsFixer\Tests\TestCase'), sprintf('Expected test class "%s" to be a subclass of "\PHPUnit\Framework\TestCase".', $testClassName));
    }
